...
AIVO 前端是基于 React + TypeScript 构建的 AI 智能面试平台 UI，提供流畅的用户体验，支持简历上传、AI 面试、实时语音转写、神态分析等功能。
...
前端仓库：https://github.com/jiunianyiwubuwei/AIVO

主仓库：https://github.com/jiunianyiwubuwei/AIVO
